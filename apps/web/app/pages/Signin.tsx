    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      >
        ...
        <Link to="/" className="flex items-center justify-center gap-2 mb-8">
          ...
          <span className="font-bold text-2xl">Sketchboard</span>
        </Link>

        {/* Card */}
        <div className="bg-card border-2 border-border rounded-3xl p-8 shadow-sketch">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            ...
            <form className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="password"
                  type="password"
                  placeholder="Your secret scribbles"
                  className="h-12 rounded-xl border-2 text-base"
                />
              </div>
